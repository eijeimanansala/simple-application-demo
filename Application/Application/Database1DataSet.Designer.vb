...
Partial Public Class Database1DataSet
    ...
    Partial Public Class ProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddProductsRow(ByVal ProductID As Integer, ByVal ProductName As String, ByVal Quantity As Integer, ByVal Description As String, ByVal Category As String) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            Dim columnValuesArray() As Object = New Object() {ProductID, ProductName, Quantity, Description, Category}
    ...
    Partial Public Class UsersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddUsersRow(ByVal UserID As Integer, ByVal Username As String, ByVal Password As String, ByVal ConfirmPassword As String) As UsersRow
            Dim rowUsersRow As UsersRow = CType(Me.NewRow,UsersRow)
            Dim columnValuesArray() As Object = New Object() {UserID, Username, Password, ConfirmPassword}
        ...
        Private Sub InitClass()
            ...
            Me.columnConfirmPassword.AllowDBNull = false
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductID] = @Original_ProductID) AND ([Pro"& _ 
                "ductName] = @Original_ProductName) AND ([Quantity] = @Original_Quantity) AND ([D"& _ 
                "escription] = @Original_Description) AND ([Category] = @Original_Category))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductID], [ProductName], [Quantity], [Descriptio"& _ 
                "n], [Category]) VALUES (@ProductID, @ProductName, @Quantity, @Description, @Cate"& _ 
                "gory);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ProductID, ProductName, Quantity, Description, Category FROM Prod"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [ProductID] = @ProductID, [ProductName] = @ProductNam"& _ 
                "e, [Quantity] = @Quantity, [Description] = @Description, [Category] = @Category "& _ 
                "WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_Produc"& _ 
                "tName) AND ([Quantity] = @Original_Quantity) AND ([Description] = @Original_Desc"& _ 
                "ription) AND ([Category] = @Original_Category));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ProductID, ProductName,"& _ 
                " Quantity, Description, Category FROM Products WHERE (ProductID = @ProductID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Application.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ProductID, ProductName, Quantity, Description, Category FROM dbo.Products"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database1DataSet.ProductsDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database1DataSet.ProductsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database1DataSet.ProductsDataTable = New Database1DataSet.ProductsDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database1DataSet.ProductsDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_Quantity As Integer, ByVal Original_Description As String, ByVal Original_Category As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal ProductID As Integer, ByVal ProductName As String, ByVal Quantity As Integer, ByVal Description As String, ByVal Category As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ProductID As Integer, ByVal ProductName As String, ByVal Quantity As Integer, ByVal Description As String, ByVal Category As String, ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_Quantity As Integer, ByVal Original_Description As String, ByVal Original_Category As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal ProductName As String, ByVal Quantity As Integer, ByVal Description As String, ByVal Category As String, ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_Quantity As Integer, ByVal Original_Description As String, ByVal Original_Category As String) As Integer
            Return Me.Update(Original_ProductID, ProductName, Quantity, Description, Category, Original_ProductID, Original_ProductName, Original_Quantity, Original_Description, Original_Category)
        End Function
    End Class
    ...
    Partial Public Class UsersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([UserID] = @Original_UserID) AND ([Username] = "& _ 
                "@Original_Username) AND ([Password] = @Original_Password) AND ([ConfirmPassword]"& _ 
                " = @Original_ConfirmPassword))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([UserID], [Username], [Password], [ConfirmPassword]) V"& _ 
                "ALUES (@UserID, @Username, @Password, @ConfirmPassword);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT UserID, Usernam"& _ 
                "e, Password, ConfirmPassword FROM Users WHERE (UserID = @UserID)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Users] SET [UserID] = @UserID, [Username] = @Username, [Password] ="& _ 
                " @Password, [ConfirmPassword] = @ConfirmPassword WHERE (([UserID] = @Original_Us"& _ 
                "erID) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password"& _ 
                ") AND ([ConfirmPassword] = @Original_ConfirmPassword));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT UserID, Username"& _ 
                ", Password, ConfirmPassword FROM Users WHERE (UserID = @UserID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT UserID, Username, Password, ConfirmPassword FROM dbo.Users"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Overridable Function Delete(ByVal Original_UserID As Integer, ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_ConfirmPassword As String) As Integer
            ...
            Else
                Me.Adapter.DeleteCommand.Parameters(3).Value = CType(Original_ConfirmPassword,String)
            End If
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.DeleteCommand.Connection.State
            If ((Me.Adapter.DeleteCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal UserID As Integer, ByVal Username As String, ByVal Password As String, ByVal ConfirmPassword As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal UserID As Integer, ByVal Username As String, ByVal Password As String, ByVal ConfirmPassword As String, ByVal Original_UserID As Integer, ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_ConfirmPassword As String) As Integer
            ...
            If (ConfirmPassword Is Nothing) Then
                Throw New Global.System.ArgumentNullException("ConfirmPassword")
            Else
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(ConfirmPassword,String)
            End If
            ...
            If (Original_ConfirmPassword Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_ConfirmPassword")
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_ConfirmPassword,String)
            End If
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.UpdateCommand.Connection.State
            If ((Me.Adapter.UpdateCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Username As String, ByVal Password As String, ByVal ConfirmPassword As String, ByVal Original_UserID As Integer, ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_ConfirmPassword As String) As Integer
            Return Me.Update(Original_UserID, Username, Password, ConfirmPassword, Original_UserID, Original_Username, Original_Password, Original_ConfirmPassword)
        End Function
    End Class
